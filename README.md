...
5. ✅ **Modifiers** — talismans + physick + buffs with correct stacking (flat attribute bonuses feed into scaling; % effects: strongest-applies within a group, multiplicative across groups). 32-entry catalogue covering everything the model can represent faithfully. Wired into rank & optimize; selectable in the UI. Flat-elemental weapon buffs / greases and spell-scaling buffs deferred.
